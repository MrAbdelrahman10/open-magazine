<div class="collapse in" id="collapseSearch">
    <form method="get" class="form-horizontal" role="form">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo Label('search[t.Q]', $_Q, 'class="col-sm-4 control-label"'); ?>
                <div class="col-sm-8">
                    <?php echo InputBox('search[t.Q]', $_GET['search']['t.Q'], $_Q); ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
        ...
        <table class="table table-striped table-bordered bootstrap-datatable ">
            <thead>
                <tr>
                    ...
                    <th><?php echo Anchor(SetSortingOrderLink('Q'), $_Q); ?></th>
